 ...
 *类描述 ：用户参数配置
 ****************************************************************************/
public class JDialogUserConfig extends JDialog {
     ...
     *************************************************/
    public JDialogUserConfig(Frame parent, boolean modal, NativeLong lUserID, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo, HCNetSDK.NET_DVR_IPPARACFG  strIpparaCfg) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1 = new JLabel();
        jLabel2 = new JLabel();
        jComboBoxPriority = new JComboBox();
        jLabel3 = new JLabel();
        jLabel4 = new JLabel();
        jComboBoxUser = new JComboBox();
        jLabel5 = new JLabel();
        jTextFieldUserIP = new JTextField();
        jTextFieldUserName = new JTextField();
        jLabel6 = new JLabel();
        jPasswordFieldPassConfirm = new JPasswordField();
        jPasswordFieldPassword = new JPasswordField();
        jLabel7 = new JLabel();
        jTextFieldMac1 = new JTextField();
        jTextFieldMac2 = new JTextField();
        jTextFieldMac3 = new JTextField();
        jTextFieldMac4 = new JTextField();
        jTextFieldMac5 = new JTextField();
        jTextFieldMac6 = new JTextField();
        jLabel9 = new JLabel();
        jLabel10 = new JLabel();
        jLabel11 = new JLabel();
        jLabel12 = new JLabel();
        jLabel13 = new JLabel();
        jPanelLocal = new JPanel();
        ...
        jLabel14 = new JLabel();
        jComboBoxRemote = new JComboBox();
        jButtonSaveRemote = new JButton();
        jButtonSaveUser = new JButton();
        ...
        jPanel1.setForeground(new Color(0, 70, 213));
        ...
        jComboBoxPriority.setModel(new DefaultComboBoxModel(new String[] { "普通用户", "操作员", "管理员" }));
        ...
        jComboBoxUser.setModel(new DefaultComboBoxModel(new String[] { "超级用户", "用户1", "用户2", "用户3", "用户4", "用户5", "用户6", "用户7", "用户8", "用户9", "用户10", "用户11", "用户12", "用户13", "用户14", "用户15", "用户16", "用户17", "用户18", "用户19", "用户20", "用户21", "用户22", "用户23", "用户24", "用户25", "用户26", "用户27", "用户28", "用户29", "用户30", "用户31" }));
        ...
        jPanelLocal.setBorder(BorderFactory.createTitledBorder("设备本地权限"));
        ...
        jComboBoxLocal.setModel(new DefaultComboBoxModel(new String[] { "本地回放", "本地录像", "云台控制", "本地备份" }));
        ...
        GroupLayout jPanelLocalLayout = new GroupLayout(jPanelLocal);
        jPanelLocal.setLayout(jPanelLocalLayout);
        jPanelLocalLayout.setHorizontalGroup(
            jPanelLocalLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanelLocalLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addGroup(jPanelLocalLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanelLocalLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelLocalLayout.createSequentialGroup()
                        .addComponent(jLabel8, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jComboBoxLocal, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanelLocalLayout.createSequentialGroup()
                        .addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jButtonSaveLocal, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanelLocalLayout.setVerticalGroup(
            jPanelLocalLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, jPanelLocalLayout.createSequentialGroup()
                .addGroup(jPanelLocalLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    .addComponent(jSeparator1, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
                    .addGroup(GroupLayout.Alignment.LEADING, jPanelLocalLayout.createSequentialGroup()
                        .addComponent(jCheckBoxLocalPlayback)
                        ...
                        .addComponent(jCheckBoxLocalState))
                    .addGroup(GroupLayout.Alignment.LEADING, jPanelLocalLayout.createSequentialGroup()
                        .addGroup(jPanelLocalLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel8)
                            .addComponent(jComboBoxLocal, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanelRemote.setBorder(BorderFactory.createTitledBorder("客户端远程权限"));
        ...
        jComboBoxRemote.setModel(new DefaultComboBoxModel(new String[] { "远程回放", "远程预览", "远程手动录像", "远程云台控制" }));
        ...
        GroupLayout jPanelRemoteLayout = new GroupLayout(jPanelRemote);
        jPanelRemote.setLayout(jPanelRemoteLayout);
        jPanelRemoteLayout.setHorizontalGroup(
            jPanelRemoteLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanelRemoteLayout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addGroup(jPanelRemoteLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(jCheckBoxRemotePlayback)
                    .addGroup(jPanelRemoteLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanelRemoteLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanelRemoteLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanelRemoteLayout.createSequentialGroup()
                        .addComponent(jLabel14, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jComboBoxRemote, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                    .addComponent(jScrollPane2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jButtonSaveRemote, GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)
                .addGap(10, 10, 10))
        );
        jPanelRemoteLayout.setVerticalGroup(
            ...
            .addGroup(jPanelRemoteLayout.createSequentialGroup()
                ...
                .addComponent(jCheckBoxRemoteAlarm))
            .addGroup(jPanelRemoteLayout.createSequentialGroup()
                .addGroup(jPanelRemoteLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jComboBoxRemote, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel14))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane2, GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE))
            .addGroup(GroupLayout.Alignment.TRAILING, jPanelRemoteLayout.createSequentialGroup()
                .addComponent(jCheckBoxRemoteSetPara)
                .addGap(2, 2, 2)
                .addComponent(jCheckBoxRemoteVoice)
                .addGap(2, 2, 2)
            ...
            .addComponent(jSeparator2, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, 604, GroupLayout.PREFERRED_SIZE)
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup()
                .addGap(33, 33, 33)
                .addComponent(jButtonSetup, GroupLayout.PREFERRED_SIZE, 72, GroupLayout.PREFERRED_SIZE)
                .addGap(44, 44, 44)
                .addComponent(jButtonUPdate, GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 281, Short.MAX_VALUE)
                .addComponent(jButtonExit, GroupLayout.PREFERRED_SIZE, 75, GroupLayout.PREFERRED_SIZE)
                .addGap(54, 54, 54))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, 555, GroupLayout.PREFERRED_SIZE)
   ...
   private void initialDialog()
   {
    ...
    private JButton jButtonSaveLocal;
    private JButton jButtonSaveRemote;
    private JButton jButtonSaveUser;
    ...
    private JComboBox jComboBoxLocal;
    private JComboBox jComboBoxPriority;
    private JComboBox jComboBoxRemote;
    ...
    private JPasswordField jPasswordFieldPassConfirm;
    private JPasswordField jPasswordFieldPassword;
    private JScrollPane jScrollPane1;
    private JScrollPane jScrollPane2;
    private JSeparator jSeparator1;
    private JSeparator jSeparator2;
    private JTextField jTextFieldMac1;
    private JTextField jTextFieldMac2;
    private JTextField jTextFieldMac3;
    private JTextField jTextFieldMac4;
    private JTextField jTextFieldMac5;
    private JTextField jTextFieldMac6;
    private JTextField jTextFieldUserIP;
