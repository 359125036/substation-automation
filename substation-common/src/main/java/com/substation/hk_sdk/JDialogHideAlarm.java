...
public class JDialogHideAlarm extends JDialog {
     ...
     *************************************************/
    public JDialogHideAlarm(JDialog parent, boolean modal, NativeLong lUserID, int iChannelNum, HCNetSDK.NET_DVR_PICCFG_V30 struPicCfg, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo) {
        super(parent, modal);
        initComponents();
   ...
   /*************************************************
    ...
    private void initComponents() {
        ...
        jComboBoxSensitive.setModel(new DefaultComboBoxModel(new String[] { "低灵敏度", "中灵敏度", "高灵敏度" }));
