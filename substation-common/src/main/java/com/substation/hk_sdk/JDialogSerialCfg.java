...
public class JDialogSerialCfg extends JDialog
{
    ...
    private void initComponents() {
        ...
        jPanel9 = new JPanel();
        jLabel36 = new JLabel();
        jComboBoxPPPMode = new JComboBox();
        jLabel37 = new JLabel();
        jComboBoxRedialMode = new JComboBox();
        jLabel38 = new JLabel();
        ...
        jPanel7 = new JPanel();
        jComboBox232Rate = new JComboBox();
        jComboBox232DataBit = new JComboBox();
        jComboBox232StopBit = new JComboBox();
        jComboBox232CheckBit = new JComboBox();
        jComboBox232Flow = new JComboBox();
        jLabel5 = new JLabel();
        jLabel4 = new JLabel();
        jLabel3 = new JLabel();
        jLabel2 = new JLabel();
        jLabel1 = new JLabel();
        jComboBoxOperateMode = new JComboBox();
        jLabel6 = new JLabel();
        jPanel485 = new JPanel();
        jButtonSetup485 = new JButton();
        jButtonExit2 = new JButton();
        jPanel10 = new JPanel();
        jComboBox485Channel = new JComboBox();
        jLabel16 = new JLabel();
        jPanel6 = new JPanel();
        jComboBox485Rate = new JComboBox();
        jLabel19 = new JLabel();
        jComboBox485Flow = new JComboBox();
        jComboBox485StopBit = new JComboBox();
        jLabel22 = new JLabel();
        jTextFieldDecodeAddress = new JTextField();
        jComboBoxDecodeType = new JComboBox();
        jLabel23 = new JLabel();
        jLabel17 = new JLabel();
        jLabel18 = new JLabel();
        jLabel20 = new JLabel();
        jComboBox485CheckBit = new JComboBox();
        jComboBox485DataBit = new JComboBox();
        jLabel21 = new JLabel();
        jPanel3 = new JPanel();
        jPanel2 = new JPanel();
        jLabel24 = new JLabel();
        jLabel25 = new JLabel();
        jComboBoxSerialType = new JComboBox();
        jComboBoxChannelNumber = new JComboBox();
        jPanel4 = new JPanel();
        jTextFieldSendData = new JTextField();
        jLabel26 = new JLabel();
        jComboBoxSendInterface = new JComboBox();
        ...
        jComboBoxPPPMode.setModel(new DefaultComboBoxModel(new String[] { "主动", "被动" }));

        jLabel37.setText("回拨模式");

        jComboBoxRedialMode.setModel(new DefaultComboBoxModel(new String[] { "拨入者指定", "预置回拨号" }));
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            .addGroup(GroupLayout.Alignment.LEADING, jPanel9Layout.createSequentialGroup()
                                ...
                                .addComponent(jTextFieldUserName, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE))
                            .addGroup(GroupLayout.Alignment.LEADING, jPanel9Layout.createSequentialGroup()
                            ...
                            .addGroup(GroupLayout.Alignment.LEADING, jPanel9Layout.createSequentialGroup()
                                .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jLabel43, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jLabel41, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                    .addComponent(jTextFieldMask, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
                                    .addComponent(jTextFieldRemoteIP, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE))))
                        .addGap(33, 33, 33))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addComponent(jCheckBoxSecret, GroupLayout.PREFERRED_SIZE, 82, GroupLayout.PREFERRED_SIZE)
                        .addGap(96, 96, 96)))
                .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addComponent(jCheckBoxRedial, GroupLayout.PREFERRED_SIZE, 58, GroupLayout.PREFERRED_SIZE)
                        .addGap(138, 138, 138))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jTextFieldTelNumber, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                            .addComponent(jTextFieldLocalIP, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                            .addComponent(jPasswordFieldPassword, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE))
                        .addGap(29, 29, 29))))
        );
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel36)
                    .addComponent(jComboBoxPPPMode, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel37)
                    .addComponent(jComboBoxRedialMode, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel41)
                    .addComponent(jTextFieldRemoteIP, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel42)
                    .addComponent(jTextFieldLocalIP, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel9Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextFieldMask, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel44)
                    .addComponent(jTextFieldTelNumber, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        ...
        jComboBox232Rate.setModel(new DefaultComboBoxModel(new String[] { "50", "75", "110", "150", "300", "600", "1200", "2400", "4800", "9600", "19200", "38400", "57600", "76800", "115.2k" }));
        jPanel7.add(jComboBox232Rate);
        jComboBox232Rate.setBounds(20, 40, 70, 21);

        jComboBox232DataBit.setModel(new DefaultComboBoxModel(new String[] { "5", "6", "7", "8" }));
        jPanel7.add(jComboBox232DataBit);
        jComboBox232DataBit.setBounds(100, 40, 50, 21);

        jComboBox232StopBit.setModel(new DefaultComboBoxModel(new String[] { "1", "2" }));
        jPanel7.add(jComboBox232StopBit);
        jComboBox232StopBit.setBounds(180, 40, 50, 21);

        jComboBox232CheckBit.setModel(new DefaultComboBoxModel(new String[] { "无校验", "奇校验", "偶校验" }));
        jPanel7.add(jComboBox232CheckBit);
        jComboBox232CheckBit.setBounds(260, 40, 62, 21);

        jComboBox232Flow.setModel(new DefaultComboBoxModel(new String[] { "无", "软流控", "硬流控" }));
        ...
        jComboBoxOperateMode.setModel(new DefaultComboBoxModel(new String[] { "窄带传输", "控制台", "透明通道" }));
        ...
        jComboBox485Rate.setModel(new DefaultComboBoxModel(new String[] { "50", "75", "110", "150", "300", "600", "1200", "2400", "4800", "9600", "19200", "38400", "57600", "76800", "115.2k" }));
        ...
        jComboBox485Flow.setModel(new DefaultComboBoxModel(new String[] { "无", "软流控", "硬流控" }));
        jPanel6.add(jComboBox485Flow);
        jComboBox485Flow.setBounds(270, 80, 70, 21);

        jComboBox485StopBit.setModel(new DefaultComboBoxModel(new String[] { "1", "2" }));
        ...
        jComboBox485CheckBit.setModel(new DefaultComboBoxModel(new String[] { "无校验", "奇校验", "偶校验" }));
        jPanel6.add(jComboBox485CheckBit);
        jComboBox485CheckBit.setBounds(90, 130, 70, 21);

        jComboBox485DataBit.setModel(new DefaultComboBoxModel(new String[] { "5", "6", "7", "8" }));
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                .addGroup(jPanel10Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGap(42, 42, 42)
                        .addComponent(jComboBox485Channel, GroupLayout.PREFERRED_SIZE, 73, GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jPanel6, GroupLayout.PREFERRED_SIZE, 400, GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel16)
                    .addComponent(jComboBox485Channel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jPanel6, GroupLayout.PREFERRED_SIZE, 250, GroupLayout.PREFERRED_SIZE)
        ...
        jComboBoxSerialType.setModel(new DefaultComboBoxModel(new String[] { "232", "485" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jComboBoxSerialType, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE)
                .addGap(29, 29, 29)
                .addComponent(jLabel25)
                .addGap(18, 18, 18)
                .addComponent(jComboBoxChannelNumber, GroupLayout.PREFERRED_SIZE, 79, GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel24)
                    .addComponent(jComboBoxSerialType, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel25)
        ...
        jComboBoxSendInterface.setModel(new DefaultComboBoxModel(new String[] { "NET_DVR_SerialSend", "NET_DVR_SendToSerialPort", "NET_DVR_SendTo232Port" }));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addComponent(jTextFieldSendData, GroupLayout.DEFAULT_SIZE, 403, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel26, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jComboBoxSendInterface, GroupLayout.PREFERRED_SIZE, 190, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 49, Short.MAX_VALUE)
                .addComponent(jButtonSend, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTextFieldSendData, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel4Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonSend)
                    .addComponent(jComboBoxSendInterface, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 413, Short.MAX_VALUE)
        );
        jPanel5Layout.setVerticalGroup(
            jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane1, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE)
        );
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(jButtonExit3, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
                        .addGap(33, 33, 33))
                    .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jTabbedPane1, GroupLayout.DEFAULT_SIZE, 454, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane1, GroupLayout.DEFAULT_SIZE, 430, Short.MAX_VALUE)
        );
    ...
    private JComboBox jComboBox232CheckBit;
    private JComboBox jComboBox232DataBit;
    private JComboBox jComboBox232Flow;
    private JComboBox jComboBox232Rate;
    private JComboBox jComboBox232StopBit;
    private JComboBox jComboBox485Channel;
    private JComboBox jComboBox485CheckBit;
    private JComboBox jComboBox485DataBit;
    private JComboBox jComboBox485Flow;
    private JComboBox jComboBox485Rate;
    private JComboBox jComboBox485StopBit;
    private JComboBox jComboBoxChannelNumber;
    private JComboBox jComboBoxDecodeType;
    private JComboBox jComboBoxOperateMode;
    private JComboBox jComboBoxPPPMode;
    private JComboBox jComboBoxRedialMode;
    private JComboBox jComboBoxSendInterface;
    private JComboBox jComboBoxSerialType;
