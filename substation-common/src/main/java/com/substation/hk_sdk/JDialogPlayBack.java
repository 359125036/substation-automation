 ...
 *类描述 ：远程文件回放操作
 ****************************************************************************/
 class JDialogPlayBack extends JDialog {
    ...
    private void initComponents() {
        ...
        jComboBoxRecodType = new JComboBox();
        jComboBoxFlieType = new JComboBox();
        jRadioButtonByCardNumber = new JRadioButton();
        ...
        jPanelPlayInfo = new JPanel();
        jTextFieldPlayTime = new JTextField();
        jButtonSave = new JButton();
        jButtonStopSave = new JButton();
        jLabel15 = new JLabel();
        jTextFieldFileName = new JTextField();
        jLabel16 = new JLabel();
        jTextFieldTotalBytes = new JTextField();
        ...
        jPanel1.setBorder(BorderFactory.createTitledBorder("查找信息"));
        ...
        jComboBoxRecodType.setModel(new DefaultComboBoxModel(new String[] { "全部", "定时录像", "移动侦测", "报警触发", "报警|动测", "报警&动测", "命令触发", "手动录像" }));
        jPanel1.add(jComboBoxRecodType);
        jComboBoxRecodType.setBounds(90, 30, 110, 21);

        jComboBoxFlieType.setModel(new DefaultComboBoxModel(new String[] { "全部", "解锁", "锁定" }));
        ...
        jPanelTime.setBorder(BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        ...
        jPanelPlayControl.setBorder(BorderFactory.createTitledBorder("回放控制"));
        ...
        jButtonPlay.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jButtonNormal.setHorizontalTextPosition(SwingConstants.CENTER);
        jButtonNormal.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        jButtonPause.setHorizontalTextPosition(SwingConstants.CENTER);
        jButtonPause.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        jPanelPlayInfo.setBorder(BorderFactory.createTitledBorder(""));
   ...
   /*************************************************
    ...
    private JButton jButtonStopSave;
    private JComboBox jComboBoxFlieType;
    private JComboBox jComboBoxRecodType;
    ...
    private JPanel jPanelPlayInfo;
    private JPanel jPanelTime;
    private JProgressBar jProgressBar;
    private JRadioButton jRadioButtonByCardNumber;
    private JScrollPane jScrollPane1;
    private JSlider jSliderPlayback;
    ...
    private JTextField jTextFieldPlayTime;
    private JTextField jTextFieldTotalBytes;
