...
class JFrameNetWorkConfig extends JFrame
{
    ...
    private void initComponents() {
        ...
        jLabel14 = new JLabel();
        jLabel15 = new JLabel();
        jComboBoxAdapter = new JComboBox();
        ...
        jComboBoxAdapter.setModel(new DefaultComboBoxModel(new String[] { "10MBase-T", "10MBase-T全双工", "100MBase-TX", "4-100M全双工", "10M/100M自适应" }));
