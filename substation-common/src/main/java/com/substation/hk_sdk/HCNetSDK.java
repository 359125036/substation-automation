...
import com.substation.utils.WebPathUtil;
import com.sun.jna.*;
...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(WebPathUtil.getWebPath()+"\\HCNetSDK.dll",
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
//校时结构参数
    ...
    public static class NET_DVR_STREAM_INFO extends Structure //回放或者下载信息结构体
    {
        public int dwSize;
        public byte[] byID= new byte[STREAM_ID_LEN];      //ID数据
        public int dwChannel;                //关联设备通道，等于0xffffffff时，表示不关联
...
{
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(WebPathUtil.getWebPath()+"\\PlayCtrl.dll",
            PlayCtrl.class);
