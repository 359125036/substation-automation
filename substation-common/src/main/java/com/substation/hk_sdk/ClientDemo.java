...
public class ClientDemo extends JFrame
{
    ...
    private void initComponents() {
        ...
        jTextFieldIPAddress.setText("218.106.157.166");

        jLabelPortNumber.setText("端口");

        jLabelPassWord.setText("密码");

        jPasswordFieldPassword.setText("ydyf2020");
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        ...
        if (userID == -1)
        {
            ...
            JOptionPane.showMessageDialog(ClientDemo.this, "注册失败，错误号:"+hCNetSDK.NET_DVR_GetLastError());
        }
        else
        {
            CreateDeviceTree();
    ...
    public static void main(String args[])
    {
        ...
        EventQueue.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                ...
                hCNetSDK.NET_DVR_SetLogToFile(3,"E:\\SDK\\log",false);
