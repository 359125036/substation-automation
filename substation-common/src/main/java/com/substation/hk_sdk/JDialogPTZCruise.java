 ...
 *类描述 ：设置巡航路径
 ****************************************************************************/
public class JDialogPTZCruise extends JDialog
{
    ...
    private void initComponents() {
        ...
        jPanel1 = new JPanel();
        jLabel1 = new JLabel();
        jComboBoxCruiseRoute = new JComboBox();
        jPanel2 = new JPanel();
        jLabel2 = new JLabel();
        jLabel3 = new JLabel();
        jLabel4 = new JLabel();
        jLabel5 = new JLabel();
        jComboBoxCruisePoint = new JComboBox();
        jComboBoxTime = new JComboBox();
        jComboBoxSpeed = new JComboBox();
        jComboBoxPresetPoint = new JComboBox();
        ...
        jPanel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createTitledBorder("巡航点")));
    ...
    private JComboBox jComboBoxCruisePoint;
    private JComboBox jComboBoxCruiseRoute;
    private JComboBox jComboBoxPresetPoint;
