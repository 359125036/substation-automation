 ...
 *类描述 ：设备状态显示
 ****************************************************************************/
public class JDialogDeviceState extends JDialog
{
    ...
    private void initComponents() {
        ...
        jTable2 = new JTable();
        jPanelChannelState = new JPanel();
        jScrollPane1 = new JScrollPane();
        jTableChannelState = new JTable();
        jPanelHDState = new JPanel();
        jScrollPane3 = new JScrollPane();
        jTableHDState = new JTable();
        jPanel1 = new JPanel();
        jLabel2 = new JLabel();
        jLabel3 = new JLabel();
        jLabel4 = new JLabel();
        jTextFieldDeviceIP = new JTextField();
        jTextFieldDeviceState = new JTextField();
        jTextFieldTotalLink = new JTextField();
        ...
        jPanelChannelState.setBorder(BorderFactory.createTitledBorder("通道状态"));

        jTableChannelState.setModel(this.initialChannelTableModel());
        jScrollPane1.setViewportView(jTableChannelState);

        GroupLayout jPanelChannelStateLayout = new GroupLayout(jPanelChannelState);
        jPanelChannelState.setLayout(jPanelChannelStateLayout);
        jPanelChannelStateLayout.setHorizontalGroup(
            jPanelChannelStateLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, jPanelChannelStateLayout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanelHDState.setBorder(BorderFactory.createTitledBorder("硬盘状态"));

        jTableHDState.setModel(this.initialHDTableModel());
        jScrollPane3.setViewportView(jTableHDState);

        GroupLayout jPanelHDStateLayout = new GroupLayout(jPanelHDState);
        jPanelHDState.setLayout(jPanelHDStateLayout);
        jPanelHDStateLayout.setHorizontalGroup(
            jPanelHDStateLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanelHDStateLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane3, GroupLayout.DEFAULT_SIZE, 614, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanelHDStateLayout.setVerticalGroup(
            jPanelHDStateLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanelHDStateLayout.createSequentialGroup()
                .addComponent(jScrollPane3, GroupLayout.PREFERRED_SIZE, 236, GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.setBorder(BorderFactory.createTitledBorder("设备状态"));
 ...
 private void jButtonExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExitActionPerformed
    ...
    private JPanel jPanelChannelState;
    private JPanel jPanelHDState;
    private JScrollPane jScrollPane1;
    private JScrollPane jScrollPane2;
    private JScrollPane jScrollPane3;
    private JTable jTable2;
    private JTable jTableChannelState;
    private JTable jTableHDState;
    private JTextField jTextFieldDeviceIP;
    private JTextField jTextFieldDeviceState;
    private JTextField jTextFieldTotalLink;
